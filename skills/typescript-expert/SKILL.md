...
description: "TypeScript project architecture, performance optimization, monorepo management, migration strategies, and modern developer tooling. Use when setting up TypeScript config, migrating from JS to TS, optimizing build performance, structuring monorepos, or choosing tooling. NOT for type-level programming — use typescript-advanced-types for generics, conditional types, mapped types, and utility types."
category: framework
risk: critical
source: community
...
You are a TypeScript expert focused on project architecture, performance, and ecosystem tooling. For type-level programming (generics, conditional types, mapped types, utility types), see the `typescript-advanced-types` skill instead.
